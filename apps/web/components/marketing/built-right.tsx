...
const items: Item[] = [
    ...
    },
    {
        ...
        description:
            "Your Mac prepares the recording, transcribes it, and redacts detected secrets before anything leaves. The frames and transcript then go straight to your AI provider on your own key. No Zerro servers.",
    },
    {
        icon: KeyRound,
        title: "Bring your own key",
        description:
            "Zerro is bring-your-own-key only. Your OpenAI, Gemini & Anthropic keys live in the macOS Keychain, and every generation request goes straight from your Mac to your provider on your key, never through Zerro's servers.",
    },
    {
        icon: Timer,
    ...
    },
    {
        ...
        description:
            "The official build ships as a code-signed, notarized .dmg, so Gatekeeper will not complain. The source is open under GPL-3.0-or-later if you'd rather build it yourself.",
    },
    {
        icon: RefreshCw,
