...
§11) — the single source of truth for the copy below, byte-identical, no
re-wrapping:
...
this file via `#filePath`) — drift fails the suite, exactly like the
`prompt-v2.md` mirror for the normal prompt.
