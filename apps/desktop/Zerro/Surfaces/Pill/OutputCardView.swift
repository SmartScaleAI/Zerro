...
struct OutputCardView: View {
    ...
    private var noNarrationNote: some View {
        HStack(alignment: .top, spacing: 8) {
            ...
            Text("No narration detected, so this prompt was generated from your screen alone. For a sharper result, record again and describe what you want.")
                .font(.system(size: 12))
                .foregroundStyle(Color.vfTextSecondary)
    ...
    private var stoppedBySleepNote: some View {
        HStack(alignment: .top, spacing: 8) {
            ...
            Text("Recovered from a recording that stopped when your Mac went to sleep. This prompt was built from what you captured before then.")
                .font(.system(size: 12))
                .foregroundStyle(Color.vfTextSecondary)
                .fixedSize(horizontal: false, vertical: true)
        }
